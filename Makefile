...
$(EXEC): $(LEX_OBJ) $(YACC_OBJ) $(AST_OBJ) $(SYMTAB_OBJ) $(BUILDSYMTAB_OBJ) $(TYPECHECK_OBJ) $(THREE_ADDRESS_OBJ) $(ASSEMBLY_OBJ) $(MAIN_OBJ) $(UTILS_OBJ) $(OPT_OBJ)
	$(CC) $(LEX_OBJ) $(YACC_OBJ) $(AST_OBJ) $(SYMTAB_OBJ) $(BUILDSYMTAB_OBJ) $(TYPECHECK_OBJ) $(UTILS_OBJ) $(THREE_ADDRESS_OBJ) $(ASSEMBLY_OBJ) $(MAIN_OBJ) $(OPT_OBJ) $(CFLAGS) -o $@

.PHONY: clean
clean:
	rm -f $(LEX_OBJ) $(YACC_OBJ) $(YACC_H) $(OPT_OBJ) $(AST_OBJ) $(BUILDSYMTAB_OBJ) $(SYMTAB_OBJ) $(UTILS_OBJ) $(TYPECHECK_OBJ) $(THREE_ADDRESS_OBJ) $(ASSEMBLY_OBJ) $(MAIN_OBJ) $(EXEC)
