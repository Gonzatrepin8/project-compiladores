...
CONST_PROP_SRC = $(SRCDIR)/opt/const_prop.c
...
CONST_PROP_OBJ = $(SRCDIR)/opt/const_prop.o
...
$(CONST_PROP_OBJ): $(CONST_PROP_SRC)
	$(CC) -c $(CONST_PROP_SRC) $(CFLAGS) -o $@

$(MAIN_OBJ): $(MAIN_SRC)
	$(CC) -c $(MAIN_SRC) $(CFLAGS) -o $@

$(EXEC): $(LEX_OBJ) $(YACC_OBJ) $(AST_OBJ) $(SYMTAB_OBJ) $(BUILDSYMTAB_OBJ) $(TYPECHECK_OBJ) $(THREE_ADDRESS_OBJ) $(ASSEMBLY_OBJ) $(MAIN_OBJ) $(UTILS_OBJ) $(CONST_PROP_OBJ)
	$(CC) $(LEX_OBJ) $(YACC_OBJ) $(AST_OBJ) $(SYMTAB_OBJ) $(BUILDSYMTAB_OBJ) $(TYPECHECK_OBJ) $(UTILS_OBJ) $(THREE_ADDRESS_OBJ) $(ASSEMBLY_OBJ) $(MAIN_OBJ) $(CONST_PROP_OBJ) $(CFLAGS) -o $@

.PHONY: clean
clean:
	rm -f $(LEX_OBJ) $(YACC_OBJ) $(YACC_H) $(CONST_PROP_OBJ) $(AST_OBJ) $(BUILDSYMTAB_OBJ) $(SYMTAB_OBJ) $(UTILS_OBJ) $(TYPECHECK_OBJ) $(THREE_ADDRESS_OBJ) $(ASSEMBLY_OBJ) $(MAIN_OBJ) $(EXEC)
