...
\subsection{Diseño y decisiones clave}
La optimización se centra en dos técnicas principales: \textbf{propagación de constantes} y \textbf{eliminación de código muerto (dead code elimination)}. Ambas se implementaron directamente sobre el AST, antes de generar el Código de Tres Direcciones (TAC).
...
También surgió un problema al intentar ejecutar varios \texttt{scanf} secuenciales en el código generado. Al analizarlo, descubrimos que el offset se calcula de una manera distinta que el que se necesita para scanf. Estamos en proceso de solucionarlo.
